...
export default function HomeScreen() {
  ...
  const handlePressSeries = useCallback((id: number) => {
    setSelectedId(id);
  }, []);
  ...
  const onRefresh = useCallback(async () => {
    ...
    setRefreshing(false);
  }, [refetchFeatured, refetchRecent, refetchCategories, refetchAll]);

  // Build per-category rows from allSeries
        ...
        {!allLoading && !recentLoading && (allSeries?.length ?? 0) === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyBody, { color: colors.mutedForeground }]}>
              When your Telegram channel receives video files, they'll appear here automatically.
            </Text>
          </View>
        )}
      </ScrollView>
